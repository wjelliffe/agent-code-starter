---
name: sdlc-do
description: Execute one bounded implementation unit using a strict, full SDLC flow with two approval gates and deterministic scripts.
metadata:
  short-description: Bounded SDLC execution
---

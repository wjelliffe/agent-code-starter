---
name: sdlc-do
description: Use when a GitHub issue or direct request should go through a full two-gate delivery flow with explicit planning, test-first execution when practical, deterministic runtime scripts, and scripted closeout.
metadata:
...
Use this skill for full delivery from plan through closeout with exactly two approval gates.

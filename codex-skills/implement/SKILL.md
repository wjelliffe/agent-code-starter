---
name: implement
description: Execute a single GitHub issue or direct request with a minimal, low-token implementation flow using deterministic scripts and one final approval gate.
metadata:
